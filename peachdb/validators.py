...
def validate_embeddings_output_s3_bucket_uri(output_bucket_s3_uri: str):
    assert (
        output_bucket_s3_uri
    ), "output_bucket_s3_uri parameter is missing. Please provide a valid local directory path or an S3 URI."

    assert is_s3_uri(output_bucket_s3_uri), f"The provided output_bucket_s3_uri {output_bucket_s3_uri} is not a S3 URI"
