...
def add_BotServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'peachdb.BotService', rpc_method_handlers)
...
class BotService(object):
    ...
    def CreateBot(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/peachdb.BotService/CreateBot',
    ...
    def CreateConversation(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/peachdb.BotService/CreateConversation',
    ...
    @staticmethod
    def ContinueConversation(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/peachdb.BotService/ContinueConversation',
